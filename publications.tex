...
\begin{enumerate}
    ...
    \item [58.] {\it Teaching Parallel and Distributed Computing Concepts in Simulation with WRENCH},
        H. Casanova, R. Tanaka, W. Koch, R. Ferreira da Silva,
        \emph{Journal of Parallel and Distributed Computing (JPDC)}, 156, 53--63, {\bf 2021}.

    \item [57.] {\it Beyond Binary Search: Parallel In-place Construction of Implicit Search Tree Layouts}, K. Berney, H. Casanova, B. Karsin, N. Sitchinava, \emph{IEEE Transactions on Computers (TC)}, to appear, {\bf 2021}.
...
% Kluwer Scheduling Book Chapter (Holly)
\item [6.] 
