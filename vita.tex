...
\documentclass[times,12pt]{letter}
...
\item [{\bf 04/12 - present:}] Visiting Professor, National Institute of Informatics,  Tokyo, Japan.
...
\begin{itemize}
\item [-] UHM, ICS312 (UG): Machine-Level and Systems Programming (SP15, SP14, SP10, SP09, FA07)
\item [-] UHM, ICS432 (UG): Concurrent and High-Performance Programming (SP15, FA11, FA08, SP07)
\item [-] UHM, ICS632 (GR): Principles of High Performance Computing (FA15, FA14, FA08, FA07, FA06, FA05)
\item [-] UHM, ICS412/332 (UG): Operating Systems (SP14, SP13, FA12, SP12, SP11, FA09)
...
\item [-] UHM, ICS491 (UG): Introduction to High Performance Computing (SP06)
...
\begin{itemize}
\item[-] Visiting Associate Professor, National Informatics Institute (NII), Japan, 03/2013-present.
...
{\bf Journals}
\begin{itemize}
\item[--] 2012-present: {\bf Subject Area Editor} for the \emph{Parallel Computing} journal.
...
\begin{itemize}
\item [2016]
\item[--]  Workshop on Job Scheduling Strategies for Parallel Processing (JSSPP), Hyderabad, Chicago, Illinois, May 2016.
...
\item[--]  EuroPar Conference, Scheduling and Load Balancing track, Vienna, Austra, Aug. 2015.
